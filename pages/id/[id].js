...
// After(?) fetch statically ^, this paths MAPS through all characters then dynamically chooses the mounted character via id (to have a dynamic & individual page for all characters)
export async function getStaticPaths(context) {
  ...
  return {
    paths,
    fallback: false, // when using large database - reduces loading time by NOT rendering all characters I guess
  };
}
