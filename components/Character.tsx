...
const CharacterContainer = styled.div`
  ...
  // inside link tag there should be a tag but it is not needed anymore, but to style it
  // this is the next.js(I think?) equivalent of css target smth (I guess like CharacterContainer.a.img)
  > a > img {
